...
void EnvCubemapPipeline::CreatePipeline()
{
    ...
    m_shaderModule.m_vertexShaderModule = vkn::Shader::CreateModule("shader/spv/environment.vert.spv");
    m_shaderModule.m_fragmentShaderModule = vkn::Shader::CreateModule("shader/spv/environment.frag.spv");
