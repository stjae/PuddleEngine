...
public:
    ...
    void Draw(const vk::CommandBuffer& commandBuffer, const Mesh& square, const Pipeline& pipeline);
    bool InsertImage(const std::string& filePath, vk::Format format, const vk::CommandBuffer& commandBuffer);
